...
def init(mdlParams_):
    ...
    mdlParams['saveDir'] = mdlParams_['pathBase']+'/data/isic/2019'
    ...
    for i in range(len(allSets)):
        ...
        if not foundSet:
            continue                
        # Find csv file
        file_loc = mdlParams['dataDir'] + '/label/labels2019.csv'
    ...
    ### Define Indices ###
    indices_path = mdlParams['saveDir'] + '/indices_isic2019.pkl';
