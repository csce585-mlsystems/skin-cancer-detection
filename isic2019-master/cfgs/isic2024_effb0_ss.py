...
def init(mdlParams_):
    ...
    mdlParams['saveDir'] = mdlParams_['pathBase']+'/data/isic/2024'
    # Data is loaded from here
    mdlParams['dataDir'] = mdlParams_['pathBase']+'/data/isic/2024'
    
    ### Model Selection ###
    # isic2019-efficientnet-b0
    ...
    for i in range(len(allSets)):
        ...
        if not foundSet:
            continue                
        # Find csv file
        file_loc = mdlParams['dataDir'] + '/label/labels2024.csv'
    ...
    for i in range(len(allSets)):
        ...
        files = sorted(glob(mdlParams['dataDir'] + '/image/*'))
    ...
    ### Define Indices ###
    indices_path = mdlParams['saveDir'] + '/indices_isic2024.pkl';
